$(function()
{
    var app_cover = $('#app-cover'), inp = $('.inp'), prevAction = $('#prev-action-btn'), nextAction=$('#next-action-btn'), stepComplete = false, progress = $('#progress'), timeOut = null, stepsArr = ['email','username'], stepNumber = 1, lastCompletedStep=0, totalSteps = stepsArr.length;
